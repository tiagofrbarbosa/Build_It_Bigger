 ...
 * on 2017-08-09 at 00:59:00 UTC 
 * Modify at your own risk.
 */

package tech.infofun.builditbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends MyApiRequest<tech.infofun.builditbigger.backend.myApi.model.ChuckJokes> {

    private static final String REST_PATH = "chuckjokes";
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, tech.infofun.builditbigger.backend.myApi.model.ChuckJokes.class);
    }
  ...
  public class SayHi extends MyApiRequest<tech.infofun.builditbigger.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, tech.infofun.builditbigger.backend.myApi.model.MyBean.class);
